...
class Colors:
    ...
    GRAY_2 = Light(on_color=Color(name="gray", int_color=0x808080ff),
                   off_color=Color(name="black", int_color=0x00000000), on_period_ms=1000, off_period_ms=500)
    ...
    GREEN_2 = Light(on_color=Color(name="green", int_color=0x00ff00ff),
                    off_color=Color(name="black", int_color=0x00000000), on_period_ms=1000, off_period_ms=500)
    RED_2 = Light(on_color=Color(name="red", int_color=0xff0000ff), off_color=Color(name="black", int_color=0x00000000),
                  on_period_ms=1000, off_period_ms=500);
